<nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur"
    ...
    <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
            ...
            <h6 class="font-weight-bolder mb-0 page-title">@yield('page-title', 'Dashboard')</h6>
        </nav>
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
            ...
            <ul class="navbar-nav  justify-content-end">
                ...
                <li class="nav-item d-flex align-items-center">
                    Welcome, &nbsp; <span class="teacherName text-secondary font-weight-bold"></span>
                </li>
...
<script>
    function logoutTeacher() {
        ...
        fetch("http://127.0.0.1:8000/api/teacher/logout", {
                method: "POST",
                headers: {
            ...
            .then(data => {
                if (data.status) {
                    ...
                    localStorage.removeItem("teacher_login_info");
