...
<body class="g-sidenav-show bg-gray-100">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <div class="container-fluid py-4">
            <section class="vh-100" style="background-color: #f4f5f7;">
                <div class="d-flex justify-content-center" id="createProfile"><a href="{{route('teacher.create-profile')}}" class="btn btn-primary">Create your profile</a></div>
                        ...
                        <div class="card mb-3" style="border-radius: .5rem;">
                            <div class="row g-0">
                                <div class="col-md-4 gradient-custom text-center text-muted"
                                    ...
                                    <h5 id="fullName"></h5>
                                    {{-- <p><b>Position:&nbsp;</b><span id="teacher_id"></span></p> --}}
                                    <p><b>Age:&nbsp;</b><span id="age"></span></p>
                                    <a href="{{route('teacher.update-profile')}}"><i title="Edit profile" id="editButton" class="far fa-edit mb-5"></i></a>
                                </div>
                                <div class="col-md-8">
    ...
    <script src="{{ asset('assets/js/teacher-ajax-functions/profileInfo.js') }}"></script>
